 ...
 * so if we setup a log level using <code>ZLog.init(...)</code>, all the logs which is with
...
public class LogLevel {
  ...
  /**
   * Log level for ZLog.v.
   */
  public static final int VERBOSE = 2;

  /**
   * Log level for ZLog.d.
   */
  public static final int DEBUG = 3;

  /**
   * Log level for ZLog.i.
   */
  public static final int INFO = 4;

  /**
   * Log level for ZLog.w.
   */
  public static final int WARN = 5;

  /**
   * Log level for ZLog.e.
   */
  public static final int ERROR = 6;

  /**
   * Log level for ZLog assert.
   */
  public static final int ASSERT = 7;

  /**
   * Log level for ZLog#init, printing all logs.
   */
  public static final int ALL = Integer.MIN_VALUE;

  /**
   * Log level for ZLog#init, printing no log.
   */
