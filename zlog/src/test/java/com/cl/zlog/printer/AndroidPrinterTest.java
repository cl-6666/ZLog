...
import com.cl.zlog.AssertUtil;
import com.cl.zlog.LogItem;
import com.cl.zlog.LogLevel;
import com.cl.zlog.RandomUtil;
import com.cl.zlog.ZLog;
import com.cl.zlog.ZLogUtil;
...
public class AndroidPrinterTest {
  ...
  public void setup() {
    ZLogUtil.beforeTest();
    ZLog.init(LogLevel.ALL, new AndroidPrinter() {
      @Override
